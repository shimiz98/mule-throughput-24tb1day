...
public class BasicOperationsTestCase extends MuleArtifactFunctionalTestCase {
  ...
  public void executeSayHiOperation() throws Exception {
	  CoreEvent result = flowRunner("test0Flow").run();
	  Object payloadValue =  result.getMessage().getPayload().getValue();
	  
	  assertThat(payloadValue.getClass().getName(), is("0123456789abcdef"));
  }
